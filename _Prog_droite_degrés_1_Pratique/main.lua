...
function love.draw()
  ...
  love.graphics.setColor(255,255,255)
    ...
    line = math.sqrt((Perso.x - (WIN_WIDTH - Perso.x))^2 + (Perso.y - (WIN_HEIGHT - Perso.y))^2)
    
    love.graphics.line(Perso.x + Perso.width, Perso.y,WIN_WIDTH/2,WIN_HEIGHT/2,WIN_WIDTH - Perso.x,WIN_HEIGHT - Perso.y)
